...
#define _DLIB_TLS_QUAL 
  ...
  /* Set to "1" for minimal impact for non-threaded applications.
   * However, this requires linker direction when locks should be used. */
  #ifndef _DLIB_THREAD_LOCK_DEFAULT_OFF
    #define _DLIB_THREAD_LOCK_DEFAULT_OFF 0
  #endif
