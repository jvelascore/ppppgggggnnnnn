 ...
 *                                TLS memory area
 *   _DLIB_TLS_MEMORY             The memory to use for the TLS memory area
 ...
 *                                TLS data segment.
 *   _DLIB_THREAD_LOCK_DEFAULT_OFF Set to 1, if the thread locks should
 *                                default to a no-operations. In this case,
 *                                the linker must redirect a number of
 *                                functions from xxx to xxx_mtx when locks
 *                                should be used.
 *
