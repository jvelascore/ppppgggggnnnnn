...
#ifdef UART_F5xx
#define UCxxIE( num, loc )   CONCATENATE( INFIX( UC, num, loc ), IE )
#define UCxxIFG( num, loc )   CONCATENATE( INFIX( UC, num, loc ), IFG )
#define UCxxIV( num, loc )   CONCATENATE( INFIX( UC, num, loc ), IV )
#define UART_IRQ_VECTOR( num, loc)            CONCATENATE( INFIX( USCI_, num, loc ), _VECTOR )
#endif
...
#ifdef UART_F5xx
#define UART_IRQ_ENABLE( num, loc, func )       ( UCxxIE(num,loc) |= INFIX( UC, func, IE ) )
#define UART_IRQ_DISABLE( num, loc, func )      ( UCxxIE(num,loc) &= ~INFIX( UC, func, IE ) )
#else
