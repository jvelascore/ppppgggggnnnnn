...
/* My functions */
int uart_txToBuffer(uint8_t *data, uint8_t index);
int uart_rxFromBuffer(uint8_t *data, uint8_t index);
int uart_txData(uint8_t *data, uint8_t index);
int uart_rxData(uint8_t data);
void uart_notifyReceivedMessage(void);

/* GLOBAL SHARED VARIABLES  */
extern uint8_t f_uartReceivedMessage;
